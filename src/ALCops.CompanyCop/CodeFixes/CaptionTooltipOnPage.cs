...
public sealed class CaptionTooltipOnPageFixProvider : CodeFixProvider
{
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext ctx)
    {
        ...
        ctx.RegisterCodeFix(
            new RemoveAction(
                string.Format(CompanyCopAnalyzers.CaptionTooltipOnPageRemoveCodeAction, propertyName),
            ...
            if (isSameProject)
            {
                ...
                ctx.RegisterCodeFix(
                    new MoveToTableAction(
                        string.Format(CompanyCopAnalyzers.CaptionTooltipOnPageMoveCodeAction, propertyName),
            ...
            if (tableName is not null && fieldName is not null)
            {
                ...
                ctx.RegisterCodeFix(
                    new MoveToTableExtensionAction(
                        string.Format(CompanyCopAnalyzers.CaptionTooltipOnPageMoveExtCodeAction, propertyName),
