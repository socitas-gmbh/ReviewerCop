...
public static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor NoGlobalVariables = new(
        ...
        title: ReviewerCopAnalyzers.NoGlobalVariablesTitle,
        messageFormat: ReviewerCopAnalyzers.NoGlobalVariablesMessageFormat,
        category: Category.Style,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: ReviewerCopAnalyzers.NoGlobalVariablesDescription,
    ...
    public static readonly DiagnosticDescriptor CaptionTooltipOnPage = new(
        ...
        title: ReviewerCopAnalyzers.CaptionTooltipOnPageTitle,
        messageFormat: ReviewerCopAnalyzers.CaptionTooltipOnPageMessageFormat,
        category: Category.Design,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
